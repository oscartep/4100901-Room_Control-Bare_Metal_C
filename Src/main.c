...
int main(void)
{
    ...
    uart2_send_string("     Inicio del programa\r\n");
    uart2_send_string("     Elije la accion a realizar\r\n");
    uart2_send_string("     h: LED 100%\r\n");
    uart2_send_string("     l: LED 0%\r\n");
    uart2_send_string("     t: LED ON/OF\r\n");
    uart2_send_string("    Presiona el boton para enceder el led pro 3 seg \r\n");
